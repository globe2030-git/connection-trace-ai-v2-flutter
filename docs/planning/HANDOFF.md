...
| AI 하루 한도 | `functions/src/index.ts:71` **`DAILY_LIMIT = 20`** — **P0-11 미완료**(스토어 제출 전 10으로 되돌려야 한다) |
...
>
> 나머지는 표가 맞았다. 특히 **`P0-11`(AI 하루 한도 20→10)은 여전히 미완료**다 —
> `functions/src/index.ts:71`이 `DAILY_LIMIT = 20`이다(실측).
>
