...
| # | 무엇 | 왜 지금인가 |
|---|---|---|
| ㉠ | **무료 20회가 최저 티어(₩1,000·10회)를 삼킨다** — 무료가 최저 상품의 **2배**다. ₩1,000을 살 이유가 구조적으로 사라진다. 선택지: **A** 최저 티어를 15~20회로 상향 / **B** ₩1,000 티어 `active:false`로 두고 ₩3,000(33회)을 진입 상품으로 / **C** 무료 15회 절충 | 스토어에 소모성 SKU를 올린 뒤 회수를 바꾸는 건 훨씬 번거롭다. **아직 등록 전** |
