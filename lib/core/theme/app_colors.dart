...
class AppColors {
  ...
  //
  // ⚠️ **네이버는 "브랜드 초록"과 "로그인 버튼 초록"이 다르다.**
  // 공식 버튼 PNG의 픽셀을 직접 읽어 확인했다(2026-08-21 실측).
  //
  //   #03C75A   브랜드 로고(워드마크) 초록 — 버튼 색이 아니다
  //   #03A94D   로그인 버튼 Light 테마   ← 우리가 쓰는 것
  //   #05AC4F   로그인 버튼 Dark 테마
  //
  // 버튼 이미지 뒤에 까는 색이 이 값과 다르면 **이음매가 보인다.**
  // 브랜드 색이라고 짐작해서 #03C75A 를 쓰고 있었다.
  static const Color brandNaverButton = Color(0xFF03A94D);
