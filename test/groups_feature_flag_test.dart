...
void main() {
  group('⚠️ 빌드 스위치 기본값', () {
    test('--dart-define 없이 실행되는 이 테스트 환경에서는 꺼져 있다', () {
      // 방침 v2.3 시행일(2026-08-30) 전에 실수로 켜진 채 배포되면 안 된다.
      // 켜는 절차는 group_model.dart 주석("켜는 날") 참고 — 시행일 이후
      // 기본값을 뒤집는 한 줄 커밋으로 켠다.
      expect(kGroupsFeatureEnabled, isFalse);
    });
  });
