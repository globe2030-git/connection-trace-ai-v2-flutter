...
//
// 2026-08-10: 설계값 10으로 **되돌렸다**(P0-11 완료). 2026-08-08에 사고 토큰
// 단가를 재느라 하루 여러 번 호출해야 해서 20으로 올렸었는데, 그 측정은
// 개발자 혼자 쓰는 동안 끝났고 이제 직원 테스트가 시작된다. 20인 채로 나가면
// 1인당 비용 상한이 설계의 2배가 된다.
//
